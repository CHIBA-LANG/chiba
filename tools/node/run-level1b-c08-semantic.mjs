...
const REQUIRED_TEXT = [
  ...
  "TypedFunctionTailCallI32Const",
  "TypedFunctionTailCallParam0",
  "TypedFunctionIfElseI32Const",
  "TypedFunctionIfElseTailCall",
  "TypedFunctionIfElseTailCallParam0",
  ...
  "def typed_function_if_else_no_arg_tail_call_body",
  "def typed_function_if_else_param0_tail_call_body",
  "def typed_function_tail_call_target_slice",
  "def typed_function_tail_call_target_text",
  "def typed_function_first_param_name",
  "def typed_function_has_i32_param0",
  "def typed_function_has_bool_param0",
  "def typed_function_i32_param_count",
  "def typed_function_body_returns_param0",
  "def typed_param0_call_arg_exact",
  "def typed_function_tail_call_param0_slice",
  "def typed_function_tail_call_param0_body",
  "def typed_function_tail_call_i32_const_slice",
  "def typed_function_tail_call_i32_const_arg",
  "def typed_function_tail_call_i32_const_body",
  "def typed_function_if_else_tail_call_body",
  ...
  "def typed_function_non_const_body_kind_from_surface",
