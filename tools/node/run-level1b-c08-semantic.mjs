...
const REQUIRED_TEXT = [
  ...
  "param_types: Array[TypedValueType]",
  ...
  "def typed_ast_resolve_callee",
  "def typed_ast_expr_args_from_node",
  ...
  "SourceAstExprNodeStructNew => typed_expr_from_ast_struct_new_node",
