...
const REQUIRED_TEXT = [
  ...
  "def answer_facts_from_control_surface",
  "data UsageCount",
  "data UsageSubject",
  ...
  "def cps_continuation_capability_from_answer",
  "def cps_continuation_fact_from_answer",
  "def cps_continuation_facts_from_answers",
  "def cps_continuation_facts",
  "data BranchJoinKind",
  "BranchJoinIfElse",
  "BranchJoinElseIf",
  "BranchJoinIfLet",
