...
- [ ] **Pre-C06: wasm-gc CoreIR + validator**
	...
	- **PROGRESS**: L7 Core pass 已递归给表达式节点打 `L7CoreOp`，L8 validator 保留 L7 payload 并递归输出 `L8ValidatedCoreOp`；`vp run smoke:bootstrap` 覆盖 `core-op string-slice`、`core-op continuation-package`、validation ok，以及 `core-invalid-smoke` 的 validator error dump。validator gate 已能拒绝 missing L7 core op、dangling unresolved symbol、错误 String/str/Slice payload、非法 non-many continuation package；合法 continuation 与 string/slice nanopass 不产生 validation error。仍缺真实 layout ref、tailcall、world/thread validator 和 emitter 改道 validated Core。
	- **TEST**: `timeout 10 ./chibac_amd64-unknown-linux_chiba_dev.o --project . --entry chiba_level1c_main.chiba --output level1c.o` 确认 phase1/resolve 后在后续阶段超时；`timeout 120 ...` 成功写出 `target/debug/level1c.o`；`timeout 10 ./target/debug/level1c.o core-invalid-smoke chiba-level1-grammar-spec/01-test.chiba`；`timeout 10 ./target/debug/level1c.o nanopass supports/bootstrap/continuation-multi-resume.chiba | rg -n "validation err"` 无匹配；`timeout 10 ./target/debug/level1c.o nanopass supports/semantic-gates/string_slice.chiba | rg -n "validation err"` 无匹配；`timeout 120 vp run smoke:bootstrap`、`semantic:gates`、`level1b:type-system`、`level1b:capability`、`run:all-wat`；all-wat `executed=38 instantiated=27`。
	- **HASH**: seed `7a7744ab9ace3d8e13ede45f2e5978e56cc07f597884085a9c4886753f3e268d`；`target/debug/level1c.o` `a6ae74f33ef09b0d9f9a9f4a2d82a7cd57a3f9724bf93ef52afdfad977ecb0a0`；`validate_core.chiba` `197fab3fac23475abfd3f32a6737d033152bacd931d024b8802dc321b92f9337`；`chiba_level1c_main.chiba` `6f9a4dd272346062dc64e55fb8849cc489c21c3d13f71cd50bac705b41269c1c`；`run-bootstrap-smokes.mjs` `507ac7cb45442250733cfd9c0d832145a37044bb0abe2abc26da4f4cab49fae6`。
