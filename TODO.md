...
- [ ] level-1b 不可用状态修复 / truthfulness cleanup
	...
	- **第一轮 audit 清单**:
		...
		- C07/C08 source item facts now preserve `private` visibility for `private def/type/data/extern`; alpha origins and typed item skeletons carry this bit forward for later namespace visibility checks.
