...
- C07 `compile_if` facts now keep an expression slice, not only a presence bit. Predicate parsing/eval against target facts is still not wired into item filtering.
