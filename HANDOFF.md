...
- C07 `compile_if` facts now keep an expression slice and coarse target/backend/all/or/not/unknown classification, not only a presence bit. Predicate parsing/eval against target facts is still not wired into item filtering.
