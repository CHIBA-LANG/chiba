...
pub use frontend::{
    parse_source_program, render_frontend_error, FrontendError, FrontendOutput, SourceItemSpan,
    SourceSpan,
};
pub use pipeline::{
...
pub use surface::{
    ...
    ProjectSurface, SurfaceConstructor, SurfaceData, SurfaceDef, SurfaceStatic, SurfaceType,
    SurfaceTypeField,
};
pub use template::{
