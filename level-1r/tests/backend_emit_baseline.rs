...
fn pipeline_records_backend_link_artifact() {
    ...
    assert!(visual.contains("L20BackendLink: BackendArtifact -> BackendLinkedBundle"));
    assert!(visual.contains("L21BackendCacheKey: BackendLinkedBundle -> BackendCacheKey"));
}
